...
export default function ContactPage() {
  ...
  useEffect(() => {
    ...
    const serviceQuery = queryParams.get('service');
    if (serviceQuery && availableServices.find(s => s.value === serviceQuery)) {
            ...
            <RevealOnScroll delay={200} className="mt-10 md:mt-0">
              ...
              <div className="space-y-6 text-muted-foreground">
                ...
                <div>
                  ...
                  <a href="#" target="_blank" rel="noopener noreferrer" className="hover:text-primary transition-colors">Phathutshedzo Fortune Bongwe / Fortune AI</a>
