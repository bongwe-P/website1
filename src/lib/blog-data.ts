export interface BlogPost {
  ...
  date: string;
  excerpt: string;
  imageUrl: string; // Should be a path relative to the /public directory, e.g., /images/blog/my-image.jpg
  category: string;
  tags: string[];
  content?: string;
  clientName?: string;
...
export const blogPosts: BlogPost[] = [
  {
    ...
    imageUrl: '/Rise of ai agents.jpeg',
    category: 'AI Trends',
  ...
  },
  {
    ...
    imageUrl: '/ai customer service.jpeg',
    category: 'Automation',
  ...
  },
  {
    ...
    imageUrl: '/future of workflow automation.jpeg',
    category: 'Automation',
  ...
  },
  {
    ...
    imageUrl: '/getting started with ai.jpeg',
    category: 'AI Trends',
  ...
  },
  {
    ...
    imageUrl: '/supercharge your sales.jpeg',
  ...
  },
  {
    ...
    imageUrl: '/global goods inc.jpeg',
